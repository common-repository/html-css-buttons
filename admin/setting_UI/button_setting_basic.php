...
<div class="container">
	<h2 class="home_title"><?php _e( 'General Settings', 'hcb_button' ); ?></h2>
	<div class="input_group icon_simple_none hexagons_none circle_icon_none">
		<div class="input_label">
			<label><?php _e( 'Text', 'hcb_button' ); ?></label>
		</div>
	...
	<div class="input_group">
		<div class="input_label">
			<label><?php _e( 'URL', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
	...
	<div class="input_group padding_section icon_simple_none icon_with_text_none hexagons_none circle_icon_none">
		...
		<div class="input_field">
			...
			<div class="input input_inline button_padding_right" >
				<label><?php _e( 'Right', 'hcb_button' ); ?></label>
			...
			<div class="input input_inline button_padding_bottom">
				<label><?php _e( 'Bottom', 'hcb_button' ); ?></label>
	...
	<div class="input_group button_section icon_simple_none hexagons_none circle_icon_none">
		<div class="input_label">
			<label><?php _e( 'Html Css Button', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
			...
			<div class="input text_right two_col button_height icon_with_text_none" >
				<label><?php _e( 'Height', 'hcb_button' ); ?></label>
	...
	<div class="input_group text_color_section">
		<div class="input_label">
			<label><?php _e( 'Text Color', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input two_col">
				<label><?php _e( 'Color', 'hcb_button' ); ?></label>
				<input name="button_text_color" type="text" value="<?php echo esc_attr($custom_data['button_text_color']); ?>" class="hcb_color_field" data-default-color="#000000" />
			</div>

			<div class="input two_col" >
				<label><?php _e( 'Hover Color', 'hcb_button' ); ?></label>
				<input name="button_text_hover_color" type="text" value="<?php echo esc_attr($custom_data['button_text_hover_color']); ?>" class="hcb_color_field" data-default-color="#000000" />
			</div>				
	...
	<div class="input_group font_section border_none icon_simple_none hexagons_none circle_icon_none">
		<div class="input_label">
			<label><?php _e( 'Font', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input three_col font_family">
				...
				<span class="px icon_with_text_none"><?php _e( 'PX', 'hcb_button' ); ?></span>
			</div>
