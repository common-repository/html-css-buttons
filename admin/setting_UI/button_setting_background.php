...
<div class="container">
	<h2 class="home_title"><?php _e( 'Background Settings', 'hcb_button' ); ?></h2>
	<div class="input_group background_color_section">
		<div class="input_label">
			<label><?php _e( 'Background Color', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input two_col">
				<label><?php _e( 'start', 'hcb_button' ); ?></label>
				<input name="button_bg_color_start" type="text" value="<?php echo esc_attr($custom_data['button_bg_color_start']); ?>" class="hcb_color_field" data-default-color="#000000" />
			</div>

			<div class="input two_col hexagons_none" >
				<label><?php _e( 'End', 'hcb_button' ); ?></label>
				<input name="button_bg_color_end" type="text" value="<?php echo esc_attr($custom_data['button_bg_color_end']); ?>" class="hcb_color_field" data-default-color="#000000" />
			</div>				
	...
	<div class="input_group background_hover_color_section">
		...
		<div class="input_field">
			<div class="input two_col">
				<label><?php _e( 'start', 'hcb_button' ); ?></label>
				<input name="button_bg_hover_color_start" type="text" value="<?php echo esc_attr($custom_data['button_bg_hover_color_start']); ?>" class="hcb_color_field" data-default-color="#000000" />
			</div>

			<div class="input two_col hexagons_none" >
				<label><?php _e( 'End', 'hcb_button' ); ?></label>
				<input name="button_bg_hover_color_end" type="text" value="<?php echo esc_attr($custom_data['button_bg_hover_color_end']); ?>" class="hcb_color_field" data-default-color="#000000" />
			</div>				
	...
	<div class="input_group button_opacity_section hexagons_none">
		<div class="input_label">
			<label><?php _e( 'Opacity', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input two_col">
				<label><?php _e( 'Start', 'hcb_button' ); ?></label>
	...
	<div class="input_group button_hover_opacity_section hexagons_none">
		<div class="input_label">
			<label><?php _e( 'Hover Opacity', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input two_col">
				<label><?php _e( 'Start', 'hcb_button' ); ?></label>
	...
	<div class="input_group button_gradient_section border_none hexagons_none">
		<div class="input_label">
			<label><?php _e( 'Gradient stop', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
			<div class="input two_col">				
