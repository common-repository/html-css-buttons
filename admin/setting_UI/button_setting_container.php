...
<div class="container">
	<h2 class="home_title"><?php _e( 'Container Settings', 'hcb_button' ); ?></h2>
	<div class="input_group container_use_section">
		<div class="input_label">
			<label><?php _e( 'Container Use', 'hcb_button' ); ?></label>
		</div>
	...
	<div class="input_group container_center_section">
		<div class="input_label">
			<label><?php _e( 'Container Center', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
	...
	<div class="input_group container_section">
		<div class="input_label">
			<label><?php _e( 'Container Width', 'hcb_button' ); ?> </label>
		</div>
		<div class="input_field">			
	...
	<div class="input_group container_align_section">
		<div class="input_label">
			<label><?php _e( 'Button Align', 'hcb_button' ); ?> </label>
		</div>
		<div class="input_field">
	...
	<div class="input_group margin_section border_none">
		<div class="input_label">
			<label><?php _e( 'Margin', 'hcb_button' ); ?></label>
		</div>
		<div class="input_field">
...
<div class="custom_css_box">
	<h3>Custom Css</h3>
	<textarea name="custom_css" id="hcb_custom_css_input"><?php echo $custom_data['custom_css']; ?></textarea>
